...
| `cdifdiscovery_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifDiscovery_mapping.json` | 252 KB | Dataset, VariableMeasured, SpatialExtent, AbstractGeometry/GeoCoordinates/GeoShape/Geometry, TemporalExtent/Instant/TimePosition, QualityMeasurement (+ composed Core) |
| `cdifdatadescription_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifDataDescription_mapping.json` | 392 KB | InstanceVariable, VariableMeasured, DataDownload, PrimaryKey, PrimaryKeyComponent, Statistic, Statistics, CategoryStatistics, StatisticsCollection, Category, SubstantiveValueDomain, SentinelValueDomain, EnumerationDomain, PhysicalMapping (+ composed Discovery/Core) |
| `cdifdatastructure_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifDataStructure_mapping.json` | 540 KB | full DDI-CDI structural tree: DataStructure + variants, the Component subclasses, RepresentedVariable, ReferenceVariable, DescriptorVariable, InstanceVariable, the ValueDomain subclasses, PrimaryKey, PrimaryKeyComponent, ComponentPosition (+ composed DataDescription/Discovery/Core) |
