...
| `cdifcore_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifCore_mapping.json` | 189 KB | Dataset, Agent/Person/Organization, AbstractDistribution/DataDownload/WebAPI, Action/EntryPoint/ActionResult/PropertyValueSpecification (WebAPI potentialAction subtree), Contributor, MonetaryGrant, ProvActivity, CatalogRecord, DefinedTerm, AdditionalProperty, DerivedFrom (Identifier and Reference are emitted as DataTypes) |
...
| `cdifdatadescription_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifDataDescription_mapping.json` | 524 KB | AbstractVariable (abstract parent of VariableMeasured + InstanceVariable), VariableMeasured, InstanceVariable, DataDownload, TabularTextDataSet, StructuredDataSet (PhysicalDataSet subclasses of DataDownload), PrimaryKey, PrimaryKeyComponent, Statistic, Statistics, CategoryStatistics, StatisticsCollection, Category, SubstantiveValueDomain, SentinelValueDomain, EnumerationDomain, PhysicalMapping/TextMapping/LocatorMapping, DataFingerprint (DataType) (+ composed Discovery/Core) |
| `cdifdatastructure_1-0_canonical-unique-names.xmi` | `ddi-cdi2cdifDataStructure_mapping.json` | 793 KB | full DDI-CDI structural tree: DataStructure + variants, the Component subclasses, RepresentedVariable, ReferenceVariable, DescriptorVariable, InstanceVariable, the ValueDomain subclasses, PrimaryKey/PrimaryKeyComponent/ComponentPosition, ForeignKey/ForeignKeyComponent, Substantive/SentinelConceptualDomain, ConceptSystem, ValueAndConceptDescription, UnitType, PhysicalDataSet/TabularTextDataSet/StructuredDataSet (+ composed DataDescription/Discovery/Core) |
